...
3. From this analysis, you will obtain five files, three of which will be used for the subsequent analyses: PIF4_macs2_peaks.xls, PIF4_macs2_peaks.bed and PIF4_macs2_summits.bed files. [Here is a guide to BED formated files](http://genome.ucsc.edu/FAQ/FAQformat#format1).

4. The PIF4_macs2_peaks.xls file contains a description of all of the parameters used for the analysis and summarizes information generated by the analysis.  Look at the output file section in [MACS2 documentation](https://pypi.python.org/pypi/MACS2/2.0.10.09132012).
...
**Question #1‐3**: How does the number of binding regions that you calculated compare with the number reported in the paper? Is the average width of the PIF4 peaks of a reasonable size? Refer to Oh *et al*, 2012 and explore your data in R. Explain your answer.
